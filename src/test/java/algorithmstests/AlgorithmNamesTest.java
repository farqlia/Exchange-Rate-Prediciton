...
public class AlgorithmNamesTest {
    ...
    void shouldReturnNameOfAlgorithm(){
        Assertions.assertEquals(AlgorithmInitializerExPost.LINEARLY_WEIGHTED_MOVING_AVERAGE_ALGORITHM.toString(),
    ...
    void shouldReturnCorrectInstance(){
        ...
        Assertions.assertTrue(AlgorithmInitializerExPost.LINEARLY_WEIGHTED_MOVING_AVERAGE_ALGORITHM.createAlgorithm(queue, argMap)
    ...
    void shouldReturnCorrectInstance2(){
        argMap.put(AlgorithmArguments.Names.LOOK_BACK_PERIOD, 5);
        Assertions.assertTrue(AlgorithmInitializerExPost.NAIVE_ALGORITHM_WITH_TREND.createAlgorithm(queue, argMap)
    ...
    void shouldReturnCorrectInstance3(){
        ...
        Assertions.assertTrue(AlgorithmInitializerExPost.BROWN_EXPONENTIAL_SMOOTHING_MODEL.createAlgorithm(queue, argMap)
