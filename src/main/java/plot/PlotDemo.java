...
public class PlotDemo<E> extends JComponent {
    ...
    public void drawXLabels(Graphics2D g2D, Point<LocalDate> lastPointOfData){



    }

    public void drawYLabels(Graphics2D g2D, Point<LocalDate> lastPointOfData){
    ...
    public void setScaling(java.util.List<Point<LocalDate>> data){
        ...
        double height = ((numOfYGrids - 1) * yWidth);      // Area of plotDemo where we want to draw lines
    ...
    public void plotData(java.util.List<Point<LocalDate>> data){
        drawGrid();
        plottedLines.add(getPathOfPlottedLine(data));
        debuggingPoint = data.get(data.size() - 1);
    }

    private Path2D.Double getPathOfPlottedLine(java.util.List<Point<LocalDate>> data){
    ...
    public void paintComponent(Graphics g){
        ...
        // Represents all transformations that has been done
        g2D.translate(50, 50);
